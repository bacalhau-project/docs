...
* [**Jobs**](../../setting-up/jobs/job.md): List of matching jobs.
...
* [**Job**](../../setting-up/jobs/job.md): JSON definition of the job.
...
* [**Results**](../../setting-up/jobs/spec-config.md): List of all published results.
* **NextToken** `(string)`: Pagination token.

**Example**:

Result of a job that used the [S3 Publisher](https://github.com/bacalhau-project/docs/blob/main/setting-up/other-specifications/publishers/s3/README.md):

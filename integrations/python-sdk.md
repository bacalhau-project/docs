...
### From PyPi:[​](http://localhost:3000/integration/python-sdk#from-pypi) <a href="#from-pypi" id="from-pypi"></a>

```bash
pip install bacalhau-sdk
```

### From source:[​](http://localhost:3000/integration/python-sdk#from-source) <a href="#from-source" id="from-source"></a>

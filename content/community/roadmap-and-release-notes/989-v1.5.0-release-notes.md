---
description: Version 1.5.0 updates configuration management and the web interface, improves error reporting and job progress visibility, and supports version 1.4.0.
---

...
1. Bacalhau client, see more information [here](broken-reference).
2. Whisper.
3. PyTorch.
4. Python Pandas.
...
Since the downloaded video is in mov format we convert the video to mp4 format and then upload it to our public storage in this case IPFS. To do this, a public [IPFS](https://ipfs.tech/) network can be used, or you can create your own [private IPFS network](broken-reference) and use it to pin files.

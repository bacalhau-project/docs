...
* [API](dev/api/README.md)
  * [Agent API](dev/api/agent.md)
  * [Bacalhau API](dev/api/index.md)
  * [Jobs API](dev/api/jobs.md)
  * [Nodes API](dev/api/nodes.md)
* [CLI](dev/cli-reference/README.md)
  * [Single CLI commands](dev/cli-reference/cli/README.md)
    * [Agent](dev/cli-reference/cli/agent/README.md)
      * [Agent Overview](dev/cli-reference/cli/agent/index.md)
    ...
    * [Config](dev/cli-reference/cli/config/README.md)
      * [Config Overview](dev/cli-reference/cli/config/index.md)
      * [Config Auto-Resources](dev/cli-reference/cli/config/auto-resources.md)
      * [Config Default](dev/cli-reference/cli/config/default.md)
      * [Config List](dev/cli-reference/cli/config/list.md)
      * [Config Set](dev/cli-reference/cli/config/set.md)
    * [Job](dev/cli-reference/cli/job/README.md)
      * [Job Overview](dev/cli-reference/cli/job/index.md)
    ...
    * [Node](dev/cli-reference/cli/node/README.md)
      * [Node Overview](dev/cli-reference/cli/node/index.md)

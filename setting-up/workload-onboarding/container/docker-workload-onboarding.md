...
All ingress/egress networking is limited as described in the [networking](../../networking-instructions/fundamentals.md) documentation. You won't be able to pull `data/code/weights/` etc. from an external source.
...
{% hint style="info" %}
You can specify which directory the data is written to with the [`--input`](https://github.com/bacalhau-project/docs/blob/main/setting-up/workload-onboarding/broken-reference/README.md) CLI flag.
{% endhint %}
...
{% hint style="info" %}
You can specify which directory the data is written to with the [`--output-volumes`](https://github.com/bacalhau-project/docs/blob/main/setting-up/workload-onboarding/broken-reference/README.md) CLI flag.
{% endhint %}

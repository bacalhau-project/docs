...
All ingress/egress networking is limited as described in the [networking](../../../getting-started/create-private-network.md) documentation. You won't be able to pull `data/code/weights/` etc. from an external source.

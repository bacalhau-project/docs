...
[Install the bacalhau binary](https://github.com/bacalhau-project/docs/blob/main/getting-started/installation/README.md#install-the-bacalhau-client) to run `bacalhau serve`.
